...
DB_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "plm_data.db")
...
def init_db():
    ...
    CREATE TABLE IF NOT EXISTS users (
        ...
        role        TEXT    NOT NULL CHECK(role IN ('Admin','Designer','Merchandiser','Sampling','QA')),
        email       TEXT,
    ...
    CREATE TABLE IF NOT EXISTS samples (
        ...
        sample_type     TEXT    NOT NULL CHECK(sample_type IN ('Proto','Fit','Salesman','PP','TOP','Bulk')),
        size            TEXT,
        color           TEXT,
        fabric_ref      TEXT,
        due_date        TEXT,
    ...
    if c.fetchone()[0] == 0:
        brands = [
            ('BRD001', 'Global Fashion Co.', 'USA', 'John Smith', 'john@globalfashion.com'),
            ('BRD002', 'EuroStyle Group',    'Germany', 'Hans Müller', 'hans@eurostyle.de'),
            ('BRD003', 'Asian Trends Ltd.',  'Japan', 'Yuki Tanaka', 'yuki@asiantrends.jp'),
        ]
    ...
    if c.fetchone()[0] == 0:
        merchants = [
            ('MCH001', 'Alice Johnson', 'alice@plm.com', '+1-555-0101', 'Woven'),
            ('MCH002', 'Bob Chen',      'bob@plm.com',   '+1-555-0102', 'Knits'),
            ('MCH003', 'Carol Davis',   'carol@plm.com', '+1-555-0103', 'Denim'),
        ]
